 ...
 * part of the larger image with the original image and then applying the filter.
...
public class EdgeHandling {
     ...
     * @param radius the amount of pixels to add to the width and height of the image
